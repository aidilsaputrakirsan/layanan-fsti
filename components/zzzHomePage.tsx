  ...
  return (
    <MainLayout>
      ...
      <section className="py-20 bg-gradient-to-b from-dark-bg to-dark-bg/90 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Prodi 1 - Fisika */}
              <div className="cursor-pointer" onClick={() => window.open('https://phy.itk.ac.id/', '_blank')}>
                <SafeAnimatedSection animation="slideUp" delay={0.2}>
                  <div className="bg-dark-card rounded-xl overflow-hidden shadow-xl hover:shadow-fsti-light/20 transition-all duration-500 transform hover:-translate-y-2 group h-full">
                    ...
                    <div className="p-6 flex flex-col h-full">
                      ...
                      <div className="mt-auto pt-4 border-t border-gray-700">
                        <span className="text-fsti-light hover:text-white inline-flex items-center text-sm font-medium group">
              ...
              {/* Prodi 2 - Matematika */}
              <div className="cursor-pointer" onClick={() => window.open('https://math.itk.ac.id/', '_blank')}>
                <SafeAnimatedSection animation="slideUp" delay={0.3}>
                  <div className="bg-dark-card rounded-xl overflow-hidden shadow-xl hover:shadow-fsti-light/20 transition-all duration-500 transform hover:-translate-y-2 group h-full">
              ...
              {/* Prodi 3 - Statistika */}
              <div className="cursor-pointer" onClick={() => window.open('https://stat.itk.ac.id/', '_blank')}>
              ...
              <div className="cursor-pointer" onClick={() => window.open('https://actsci.itk.ac.id/', '_blank')}>
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="cursor-pointer" onClick={() => window.open('https://ee.itk.ac.id/', '_blank')}>
                <SafeAnimatedSection animation="slideUp" delay={0.2}>
                  <div className="bg-dark-card rounded-xl overflow-hidden shadow-xl hover:shadow-fsti-light/20 transition-all duration-500 transform hover:-translate-y-2 group h-full">
              ...
              <div className="cursor-pointer" onClick={() => window.open('https://is.itk.ac.id/', '_blank')}>
                <SafeAnimatedSection animation="slideUp" delay={0.3}>
                  <div className="bg-dark-card rounded-xl overflow-hidden shadow-xl hover:shadow-fsti-light/20 transition-all duration-500 transform hover:-translate-y-2 group h-full">
              ...
              {/* Prodi 3 - Informatika */}
              <div className="cursor-pointer" onClick={() => window.open('https://if.itk.ac.id/', '_blank')}>
                <SafeAnimatedSection animation="slideUp" delay={0.4}>
                  <div className="bg-dark-card rounded-xl overflow-hidden shadow-xl hover:shadow-fsti-light/20 transition-all duration-500 transform hover:-translate-y-2 group h-full">
              ...
              <div className="cursor-pointer" onClick={() => window.open('https://bisnisdigital.itk.ac.id/', '_blank')}>
                <SafeAnimatedSection animation="slideUp" delay={0.5}>
                  <div className="bg-dark-card rounded-xl overflow-hidden shadow-xl hover:shadow-fsti-light/20 transition-all duration-500 transform hover:-translate-y-2 group h-full">
        ...
        {/* Akreditasi Section dengan struktur yang berhasil */}
        <div className="cursor-pointer" onClick={() => window.open('https://ult.itk.ac.id/sertifikat-akreditasi/', '_blank')}>
          <SafeAnimatedSection animation="fadeIn" delay={0.3}>
            <div className="text-center bg-gradient-to-r from-dark-card/60 via-dark-card to-dark-card/60 p-8 rounded-2xl border border-fsti-light/20 shadow-lg relative overflow-hidden">
              {/* Background decoration */}
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-fsti-primary/10 rounded-full opacity-70"></div>
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-fsti-primary/10 rounded-full opacity-70"></div>
              ...
              <span className="inline-flex items-center px-6 py-3 rounded-lg bg-fsti-primary hover:bg-fsti-secondary text-white font-medium transition-all duration-300 group">
...
// Export dengan SSR disabled untuk menghindari masalah hydration
