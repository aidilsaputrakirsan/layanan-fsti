    ...
    <footer className="bg-dark-card text-white z-10 relative" id="kontak">
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li>
                <p className="text-white font-medium mb-1">Wakil Dekan I (Akademik):</p>
                <p className="text-sm text-gray-300">Irma Fitria, S.Si., M.Si.</p>
              </li>
              <li>
                <p className="text-white font-medium mb-1">Wakil Dekan II (Keuangan):</p>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>&copy; {currentYear} Fakultas Sains dan Teknologi Informasi - Institut Teknologi Kalimantan. Hak Cipta Dilindungi.</p>
        </div>
      </div>
    </footer>
  );
